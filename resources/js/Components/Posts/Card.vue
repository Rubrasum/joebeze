<template>
    <div class="bg-primary-bg w-full justify-end">
        <div class="relative flex w-full justify-end">
            <div class="top-0 left-0 pt-12 mb-12 bg-primary-bg bg-opacity-60 flex flex-col justify-between">
                <div class="rounded-2xl overflow-hidden">
                    <div class="px-8 md:grid items-start md:grid-cols-10 md:gap-5
                                border-l border-secondary-bg  py-5 ">
                        ...
                        <div class="md:col-span-8 md:flex">
                            <div class="md:w-2/5 pr-3 items-start  md:flex-row  md:space-x-3">
