                ...
                <div class="mx-auto max-w-2xl gap-x-14 lg:mx-0 lg:flex lg:max-w-none lg:items-center">
                    <div class="relative w-full max-w-xl lg:shrink-0 xl:max-w-2xl">
                        ...
                        <div class="mt-10 flex items-center gap-x-6">
                            <a href="#"
                               class="rounded-md bg-accent px-3.5 py-2.5 text-sm font-semibold text-white
                                      shadow-sm hover:bg-accent focus-visible:outline focus-visible:outline-2
                                      focus-visible:outline-offset-2 focus-visible:outline-primary-gray"
                            >Get started</a>
                            <a href="#" class="text-sm font-semibold leading-6 text-primary-text">Live demo <span aria-hidden="true">→</span></a>
                        </div>
                    </div>
