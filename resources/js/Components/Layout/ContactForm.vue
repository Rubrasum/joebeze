<template>
    <div class="bg-indigo-600 ">
        <div class="relative bg-white mx-auto max-w-7xl px-6 lg:px-8 overflow-hidden">
            <div class="lg:absolute lg:inset-0 lg:left-1/2 mx-auto">
                <img class="h-64 w-full bg-indigo-600 object-cover sm:h-80 lg:absolute lg:h-full" src="https://images.unsplash.com/photo-1559136555-9303baea8ebd?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&crop=focalpoint&fp-x=.4&w=2560&h=3413&&q=80" alt="" />
            </div>
            <div class="overflow-hidden pb-24 pt-16 sm:pb-32 sm:pt-24 lg:mx-auto lg:grid lg:max-w-7xl lg:grid-cols-2 lg:pt-32">
