            ...
            <PopoverGroup class="hidden lg:flex lg:gap-x-12">
                <Popover class="relative">
                    <PopoverButton class="flex items-center gap-x-1 text-sm font-semibold leading-6 text-primary-text">
                        Product
                        <ChevronDownIcon class="h-5 w-5 flex-none text-secondary-text" aria-hidden="true" />
                    </PopoverButton>
                    ...
                    >
                        <PopoverPanel
                            class="absolute -left-8 top-full z-10 mt-3 w-screen max-w-md overflow-hidden
                                   rounded-md bg-secondary-bg shadow-lg ring-1 ring-primary-gray"
                        >
                            <div class="p-4">
                ...
                <Popover class="relative">
                    ...
                    <transition enter-active-class="transition ease-out duration-200" enter-from-class="opacity-0 translate-y-1" enter-to-class="opacity-100 translate-y-0" leave-active-class="transition ease-in duration-150" leave-from-class="opacity-100 translate-y-0" leave-to-class="opacity-0 translate-y-1">
                        <PopoverPanel class="absolute -left-8 top-full z-10 mt-3 w-96 rounded-3xl bg-secondary-bg p-4 shadow-lg ring-1 ring-primary-gray/[5]">
