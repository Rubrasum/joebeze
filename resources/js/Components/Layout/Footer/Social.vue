<template>
    <div class="md:w-1/5 mt-8 md:mt-0 ml-8 md:ml-8">
        ...
        <ul class="list-none flex">
            <li class="mr-4">
                <a class="group" aria-label="Joebeze on X" href="https://x.com/joebetbeze">
                    <svg class="h-8 w-8 fill-accent group-hover:fill-primary-text" aria-hidden="true" viewBox="0 0 24 24">
            ...
            <li>
                <a class="group" aria-label="Follow on Instagram" href="https://www.instagram.com/josephbetbeze/">
                    <svg class="h-8 w-8 fill-accent group-hover:fill-primary-text" aria-hidden="true" viewBox="0 0 24 24">
                        <path
