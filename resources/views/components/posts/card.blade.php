...
<div class="bg-black">
    <div class="w-full relative">
        <div class="top-0 left-0 w-full bg-black bg-opacity-60 flex flex-col justify-between ">
            <div class="container mx-auto xl:px-16 px-4 py-5 mb-12 grid items-center
                ...
                <div class="col-span-8 flex">
                    <div class="w-2/5 pr-3 items-center md:items-start md:flex-row md:items-baseline md:space-x-3">
                        <a href="/post/{{ $post->slug }}"><h2 class="text-white text-2xl font-bold">{{ $post->title }}</h2></a>
                        <p class="text-white my-2">Published: <span class="font-semibold"
                            >{{ $post->published_at->toFormattedDateString() }}</span></p>
                    </div>
                    ...
                    <div class="w-3/5 text-white">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <div>
                                <a href="/post/{{ $post->slug }}" class="bg-gray-500 hover:bg-gray-700 text-white
                                font-bold py-2 px-4 rounded btn-read-gray">
                                    Read more
                                </a>
                            </div>
                        </div>
