...
<div class="bg-black">
    <div class="w-full relative">
        <div class="top-0 left-0 w-full bg-black bg-opacity-60 flex
            ...
            <div class="container mx-auto px-16 pt-16 pb-8 mb-8 grid grid-cols-5
                        gap-5 border-l-8 border-r-2 border-b-2 border-gray-800 rounded-br-md">
                ...
                <div class="col-span-3">
                    <a href="/post/{{ $post->slug }}"><h1 class="text-white text-4xl font-bold">{{ $post->title }}</h1></a>
                    ...
                    <div class="flex justify-between items-center mt-2 pt-10">
                        <p class="text-white pt-2">Published: <
                            span class="font-semibold">{{ $post->published_at->diffForHumans() }}</span></p>
                        <footer>
